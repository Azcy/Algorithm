# 算法设计
## 蓝桥杯
- [基础篇](https://github.com/Azcy/Algorithm/blob/master/BlueBridge/README/Basic.md)

- [第六届蓝桥杯](https://github.com/Azcy/Algorithm/blob/master/BlueBridge/README/TheSixBridge.md)
...
- [3、插入排序------直接插入排序（Straight Insertion Sort）](https://github.com/Azcy/Algorithm/blob/master/SortingAlgorithm/README/InsertSort.md)
- [4、插入排序------希尔排序（Shell Sort）](https://github.com/Azcy/Algorithm/blob/master/SortingAlgorithm/README/ShellSort.md)
- [5、选择排序------简单选择排序（Simple Selection Sort）](https://github.com/Azcy/Algorithm/blob/master/SortingAlgorithm/README/SelectSort.md)
